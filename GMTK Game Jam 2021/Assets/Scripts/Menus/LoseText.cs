...
public class LoseText : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string[] descriptions;
        if (isPositive) {
            ratings = new string[] { "8/10", "100/100", "9/10", ":)", "Yay!", "B+", "A-", "10 Thumbs Up" };
            ...
            "Movies are now obsolete. The future is squares shooting at other squares.", "Better than the Emoji Movie.", "Can't wait for the prequels."};
        } else {
            ratings = new string[] { "1/10", "2/10", "100/5", "0/10", ":(", "Boo!", "2 Thumbs Down", "1 Shriveled Finger", "F-" };
            ...
            "It would have been better if they had let me shoot the actors personally."};
        }
